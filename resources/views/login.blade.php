...
<body>
    ...
    <section class="payment">
        ...
        <div class="pay">
            ...
            <div class="username">
                <div class="input_box">
                    <input type="email" placeholder="Email" id="Email" name="Email" required class="username">
            ...
            <div class="login">
               <p>Don't have an account yet? <a href="/register" style="color: pink;">Register</a> now!</p> 
            </div>
        </form>
            </div>
